/*
    ...
    Algorithm: 
        ...
        2. Uske baad N Queens mein check karo, if attch nahi hai, assign Q and then check for next row
        3. if agli queen rakh sakte hai true, then return 1, else waopas se - dalo, and retrun 0.
*/
